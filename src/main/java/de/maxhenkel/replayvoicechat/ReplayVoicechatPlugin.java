...
public class ReplayVoicechatPlugin implements VoicechatPlugin
{
	...
	public void registerEvents(EventRegistration registration)
	{
		registration.registerEvent(ClientReceiveSoundEvent.EntitySound.class,
			VoicechatRecorder::onEntitySound);
		registration.registerEvent(
			ClientReceiveSoundEvent.LocationalSound.class,
			VoicechatRecorder::onLocationalSound);
		registration.registerEvent(ClientReceiveSoundEvent.StaticSound.class,
			VoicechatRecorder::onStaticSound);
		registration.registerEvent(ClientSoundEvent.class,
			VoicechatRecorder::onSound);
		registration.registerEvent(OpenALSoundEvent.class,
			AudioPlaybackManager::setPlaybackRate);
	}
