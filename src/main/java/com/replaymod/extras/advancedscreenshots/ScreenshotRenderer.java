...
public class ScreenshotRenderer implements RenderInfo
{
	...
	public boolean renderScreenshot() throws Throwable
	{
		try
		{
			...
			ForceChunkLoadingHook clrg =
				new ForceChunkLoadingHook(mc.worldRenderer);
		...
		}catch(OutOfMemoryError e)
		{
			e.printStackTrace();
			CrashReport report =
				CrashReport.create(e, "Creating Equirectangular Screenshot");
	...
	{
		// render 2 frames, because only the second contains all frames fully
		// loaded
		return 2;
	}
