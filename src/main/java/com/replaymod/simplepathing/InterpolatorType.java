...
public enum InterpolatorType
{
	...
	CATMULL_ROM("catmullrom", CatmullRomSplineInterpolator.class,
		() -> new CatmullRomSplineInterpolator(0.5)),
	...
	InterpolatorType(String localizationKey,
		Class<? extends Interpolator> interpolatorClass,
	...
	public String getI18nName()
	{
		return String.format(
			"replaymod.gui.editkeyframe.interpolator.%1$s.name",
			localizationKey);
	}
	...
	{
		return String.format(
			"replaymod.gui.editkeyframe.interpolator.%1$s.desc",
			localizationKey);
	}
