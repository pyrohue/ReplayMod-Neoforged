...
public class Program
{
	...
	public Program(Identifier vertexShader, Identifier fragmentShader)
		throws Exception
	{
		int vertShader =
			createShader(vertexShader, ARBVertexShader.GL_VERTEX_SHADER_ARB);
		int fragShader = createShader(fragmentShader,
		...
		if(glGetObjectParameteriARB(program,
	...
	private int createShader(Identifier resourceLocation, int shaderType)
		throws Exception
	{
		int shader = 0;
		try
		{
			...
			Resource resource = MCVer.getMinecraft().getResourceManager()
			...
			if(glGetObjectParameteriARB(shader,
				GL_OBJECT_COMPILE_STATUS_ARB) == GL11.GL_FALSE)
	...
	public class Uniform
	{
		...
		public void set(boolean bool)
		{
			ARBShaderObjects.glUniform1iARB(location,
				bool ? GL11.GL_TRUE : GL11.GL_FALSE);
		}
