...
// $$ }
// $$
// $$ private DObject getObjectForItemStack(Object renderItem, BakedModel model,
// ItemStack stack) {
...
// $$ private static DMesh generateMeshForItemStack(Object renderItem,
...
// $$ renderQuads(renderItem, builder, model.getQuads(null, face, new Random()),
// stack);
// $$ }
// $$ renderQuads(renderItem, builder, model.getQuads(null, null, new Random()),
// stack);
// #else
// #if MC>=10904
...
// $$ }
// $$
// $$ private static void renderQuads(Object renderItem, BlendMeshBuilder
// buffer, List<BakedQuad> quads, ItemStack stack) {
// $$ for (BakedQuad quad : quads) {
// $$ int color = stack != null && quad.hasColor()
// #if MC>=10904
// $$ ? ((ItemRendererAccessor) renderItem).getItemColors().getColor(stack,
// quad.getColorIndex()) | 0xff000000
// #else
// $$ ? stack.getItem().getColorFromItemStack(stack, quad.getTintIndex()) |
// 0xff000000
// #endif
// $$ : 0xffffffff;
// #if MC>=11500
...
// $$
// $$ public ItemBasedDObject(Object renderItem, BakedModel model, ItemStack
// stack) {
...
// $$ }
// $$
// $$ public boolean isBasedOn(Object renderItem, BakedModel model, ItemStack
// stack) {
// $$ return this.renderItem == renderItem && this.model == model && this.stack
// == stack;
// $$ }
// $$
// $$ @Override
