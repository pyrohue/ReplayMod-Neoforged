...
// $$ // We however want our TileEntities object to not move when the viewer
// does,
// $$ // so we position it at 0/0/0 and instead have the tile entities
// themselves move more
...
// $$ }
// $$
// $$ public void preRender(BlockEntity tileEntity, double dx, double dy, double
// dz, float renderPartialTicks, int destroyStage, float alpha) {
// $$ // FIXME: handle alpha
...
// $$ tileEntityObject.id.name = getTileEntityId(tileEntity) + "( " + pos.getX()
// + "/" + pos.getY() + "/" + pos.getZ() + ")";
...
// $$
// $$ // Normally the tile entity renderer will translate to dx/dy/dz but we
// want that translation outside of
