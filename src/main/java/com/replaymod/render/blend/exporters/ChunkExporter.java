...
// $$ import
// com.replaymod.render.blend.mixin.ContainerLocalRenderInformationAccessor;
...
// #if MC>=10904
// $$ private final Map<BlockPos, Map<RenderLayer, DObject>> chunkLayerObjects =
// new HashMap<>();
// $$ private final List<Pair<ChunkRenderer, RenderLayer>> chunks = new
// ArrayList<>();
// #else
// $$ private final Map<BlockPos, Map<EnumWorldBlockLayer, DObject>>
// chunkLayerObjects = new HashMap<>();
// $$ private final List<Pair<RenderChunk, EnumWorldBlockLayer>> chunks = new
// ArrayList<>();
// #endif
// $$ private DObject chunksObject;
// $$ private int frame;
// $$
// $$ public void addChunkUpdate(ChunkRenderer chunk, ChunkRenderData
// compiledChunk) {
// #if MC>=10904
...
// $$ List<ContainerLocalRenderInformationAccessor> renderInfos =
// ((WorldRendererAccessor) mc.worldRenderer).getRenderInfos();
...
// $$ chunkLayerObjects.put(chunk.getOrigin(), new
// EnumMap<>(layer.getDeclaringClass()));
// $$ }
...
// $$ chunkObject.id.name = "Chunk[" + pos.getX()/16 + "/" + pos.getY()/16 + "/"
// + pos.getZ()/16 + "]";
// $$ chunkObject.loc = new Vector3f(pos.getX(), -pos.getZ(), pos.getY());
// $$ return chunkObject;
// $$ }
// $$
// $$ private DObject buildChunkLayerObject(DObject chunkObject, ChunkRenderer
// renderChunk,
// #if MC>=10904
// $$ RenderLayer layer) {
// #else
...
// $$ layerObject.id.name = chunkObject.id.name + " - " + layer + " - Frame " +
// frame;
// $$ return layerObject;
// $$ }
// $$
...
// $$ vertexBuffer.bind();
// $$ int size = GL15.glGetBufferParameteri(GLX.GL_ARRAY_BUFFER,
// GL15.GL_BUFFER_SIZE);
...
// $$
// $$ return BlendMeshBuilder.addBufferToMesh(byteBuffer, GL11.GL_QUADS,
// VertexFormats.POSITION_COLOR_UV_LMAP, null, null);
// $$ }
// $$
