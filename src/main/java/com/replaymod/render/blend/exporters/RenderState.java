...
// $$ private final ModelRendererExporter modelExporter = new
// ModelRendererExporter(this);
...
// $$ // We need to apply the same transformation T to the object that has
// transformed the old into the new matrix:
// $$ // O * T = N <=> T = O^{-1} * N
// $$ return Matrix4f.mul(Matrix4f.invert(prevModelView, null), newModelView,
// null);
// $$ }
// $$
// $$ @Override
...
// $$ LOGGER.warn("Post frame with non-empty object stack! ({} remaining)",
// objectStack.size());
// $$ objectStack.clear();
// $$ }
// $$ if (!modelViewStack.isEmpty()) {
// $$ LOGGER.warn("Post frame with non-empty model-view stack! ({} remaining)",
// modelViewStack.size());
