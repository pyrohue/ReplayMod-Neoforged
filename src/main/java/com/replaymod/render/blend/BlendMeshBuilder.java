...
// $$ if (isDrawing) {
// $$ if (!wellBehaved) {
// $$ // Someone probably finished drawing with the global instance instead of
// this one,
// $$ // let's just assume that what's happened and finish our last draw by
// ourselves
...
// $$ Tessellator.getInstance().getBuffer().begin(mode,
...
// #if MC>=10904
// #if MC>=11200
// $$ public static DMesh addBufferToMesh(BufferBuilder bufferBuilder, DMesh
// mesh, ReadableVector3f vertOffset) {
// #else
// $$ public static DMesh addBufferToMesh(VertexBuffer bufferBuilder, DMesh
// mesh, Vector3f vertOffset) {
// #endif
// #else
// $$ public static DMesh addBufferToMesh(WorldRenderer bufferBuilder, DMesh
// mesh, Vector3f vertOffset) {
// #endif
// #if MC>=11500
// $$ Pair<DrawArrayParameters, ByteBuffer> data = bufferBuilder.popData();
// $$ return addBufferToMesh(data.getSecond(), data.getFirst().getMode(),
// data.getFirst().getVertexFormat(), mesh, vertOffset);
// #else
// $$ return addBufferToMesh(bufferBuilder.getByteBuffer(),
// bufferBuilder.getDrawMode(), bufferBuilder.getVertexFormat(), mesh,
// vertOffset);
// #endif
// $$ }
// $$
...
// #endif
// $$ return addBufferToMesh(buffer, vertexCount, mode, vertexFormat, mesh,
// vertOffset);
// $$ }
// $$
// $$ public static DMesh addBufferToMesh(
...
// #endif
// $$ throw new UnsupportedOperationException("Only float is supported for
// position elements!");
// $$ }
// $$ posOffset = offset;
// $$ break;
...
// #endif
// $$ throw new UnsupportedOperationException("Only unsigned byte is supported
// for color elements!");
// $$ }
// $$ colorOffset = offset;
// $$ break;
...
// $$ if (element.getType() != VertexFormatElement.EnumType.UBYTE) {
// #endif
// $$ throw new UnsupportedOperationException("Only float is supported for UV
// elements!");
// $$ }
// $$ uvOffset = offset;
// $$ break;
...
// $$ index++;
// $$ }
// $$ if (posOffset == -1) throw new IllegalStateException("No position element
// in " + vertexFormat);
// $$
...
// $$ DMaterial activeMaterial =
// BlendState.getState().getMaterials().getActiveMaterial();
