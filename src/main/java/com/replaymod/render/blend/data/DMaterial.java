...
public class DMaterial
{
	...
	public CPointer<Material> serialize(Serializer serializer)
		throws IOException
	{
		return serializer.maybeMajor(this, id, Material.class, () -> {
			...
			return material -> {
				material.setMode(0x10000 /* MA_TRANSP */ | 0x40 /* MA_ZTRANS */
					| 0x80 /* MA_VERTEXCOLP */
				);
				material.setAlpha(1);
				material.setRef(1);
	...
	public static class DMTex
	{
		...
		public Util.IOCallable<CPointer<MTex>> serialize(Serializer serializer)
			throws IOException
		{
			...
			return () -> {
				...
				mTex.setMapto((short)(0x1 /* MAP_COL */ | 0x80 /* MAP_ALPHA */
				));
