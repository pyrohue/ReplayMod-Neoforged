...
public class IrisODSFrameCapturer implements FrameCapturer<ODSOpenGlFrame>
{
	...
	public static final Path SHADER_PACK_PATH = LoadingModList.get()
		.getModFileById("replaymod").getFile().getSecureJar().getRootPath();
	...
	public IrisODSFrameCapturer(WorldRenderer worldRenderer,
