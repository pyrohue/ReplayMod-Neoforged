	...
	PboOpenGlFrameCapturer<CubicOpenGlFrame, CubicOpenGlFrameCapturer.Data>
{
	...
	public CubicPboOpenGlFrameCapturer(WorldRenderer worldRenderer,
		RenderInfo renderInfo, int frameSize)
	{
		super(worldRenderer, renderInfo, CubicOpenGlFrameCapturer.Data.class,
			frameSize * frameSize);
	...
	{
		return new CubicOpenGlFrame(from[0], from[1], from[2], from[3], from[4],
			from[5]);
	}
}
