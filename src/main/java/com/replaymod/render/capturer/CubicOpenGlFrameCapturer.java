...
public class CubicOpenGlFrameCapturer
	extends OpenGlFrameCapturer<CubicOpenGlFrame, CubicOpenGlFrameCapturer.Data>
{
	...
	public CubicOpenGlFrameCapturer(WorldRenderer worldRenderer,
	...
	public Map<Channel, CubicOpenGlFrame> process()
	{
		...
		CubicOpenGlFrame frame =
			new CubicOpenGlFrame(renderFrame(frameId, partialTicks, Data.LEFT),
