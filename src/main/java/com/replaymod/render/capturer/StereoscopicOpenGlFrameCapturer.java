...
public class StereoscopicOpenGlFrameCapturer extends
	OpenGlFrameCapturer<StereoscopicOpenGlFrame, StereoscopicOpenGlFrameCapturer.Data>
{
	...
	public StereoscopicOpenGlFrameCapturer(WorldRenderer worldRenderer,
	...
	public Map<Channel, StereoscopicOpenGlFrame> process()
	{
		...
		StereoscopicOpenGlFrame frame =
			new StereoscopicOpenGlFrame(left, right);
