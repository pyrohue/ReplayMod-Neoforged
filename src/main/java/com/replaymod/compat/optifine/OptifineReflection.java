...
public class OptifineReflection
{
	...
	static
	{
		try
		{
			// this throws an ignored ClassNotFoundException if Optifine isn't
			// installed
			Class.forName("Config");

			gameSettings_ofFastRender =
				GameOptions.class.getDeclaredField("ofFastRender");
	...
	public static void reloadLang()
	{
		try
		{
			...
			{
				langClass = Class.forName("net.optifine.Lang"); // Post Optifine
																// 1.12.2 E1
			}
