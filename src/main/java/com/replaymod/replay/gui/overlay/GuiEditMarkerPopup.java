	...
	implements Typeable
{
	...
	public final GuiLabel title =
		new GuiLabel().setI18nText("replaymod.gui.editkeyframe.title.marker");
	...
	public final GuiNumberField pitchField =
		newGuiNumberField().setPrecision(5);
	...
	public final GuiPanel inputs = GuiPanel.builder()
		...
		.with(
			new GuiLabel().setI18nText("replaymod.gui.editkeyframe.markername"),
		...
		.with(new GuiLabel().setI18nText("replaymod.gui.editkeyframe.camroll"),
			new GridLayout.Data(0, 0.5))
		.with(rollField, new GridLayout.Data(1, 0.5)).build();
	...
	public GuiEditMarkerPopup(GuiContainer container, Marker marker,
		Consumer<Marker> onSave)
	{
		super(container);
		this.onSave = onSave;
