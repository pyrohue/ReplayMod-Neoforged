...
// TODO: When events for listening to addition of child elements are added, fire
...
public final class ButtonList extends AbstractList<ClickableWidget>
{
	...
	public ButtonList(List<Drawable> drawables, List<Selectable> selectables,
	...
	public ClickableWidget remove(int index)
	{
		...
		final ClickableWidget removedButton =
			(ClickableWidget)drawables.remove(index);
	...
	private int translateIndex(List<?> list, int index, boolean allowAfter)
	{
		...
		throw new IndexOutOfBoundsException(
			String.format("Index: %d, Size: %d", index, index - remaining));
	}
}
