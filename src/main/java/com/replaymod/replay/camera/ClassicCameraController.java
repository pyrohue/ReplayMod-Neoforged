...
public class ClassicCameraController implements CameraController
{
	...
	private static final double SPEED_CHANGE =
		(UPPER_SPEED - LOWER_SPEED) / 20000;
	...
	private void forwardCameraMovement(boolean forward, boolean backward,
	...
	private void updateMovement()
	{
		...
		camera.moveCamera(movement.x * factor, movement.y * factor,
			movement.z * factor);
	}
	...
	private void setMovement(MoveDirection dir)
	{
		...
		switch(dir)
		{
			case BACKWARD:
			direction =
				this.getVectorForRotation(-rotationPitch, rotationYaw - 180);
			break;
			case DOWN:
