...
public class SettingsRegistry
{
	...
	final SettingsRegistryBackend backend =
		new SettingsRegistryBackend(settings);
	...
	public static class SettingKeys<T> implements SettingKey<T>
	{
		...
		public SettingKeys(String category, String key, String displayString,
			T defaultValue)
		{
	...
	public static class MultipleChoiceSettingKeys<T> extends SettingKeys<T>
		implements MultipleChoiceSettingKey<T>
	{
		private List<T> choices = Collections.emptyList();

		public MultipleChoiceSettingKeys(String category, String key,
			String displayString, T defaultValue)
		{
