...
public class DelegatingReplayFile implements ReplayFile
{
	...
	@Override
	public void writeMetaData(PacketTypeRegistry registry,
	...
	@Override
	public ReplayInputStream getPacketData(PacketTypeRegistry registry)
		throws IOException
	{
	...
	@Override
	public void writeResourcePackIndex(Map<Integer, String> index)
		throws IOException
	{
	...
	@Override
	public Map<String, Timeline> getTimelines(PathingRegistry pathingRegistry)
		throws IOException
	{
	...
	@Override
	public void writeTimelines(PathingRegistry pathingRegistry,
		Map<String, Timeline> timelines) throws IOException
	{
