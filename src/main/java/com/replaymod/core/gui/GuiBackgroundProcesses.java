...
public class GuiBackgroundProcesses extends EventRegistrations
{
	...
	private void onGuiInit(net.minecraft.client.gui.screen.Screen guiScreen)
	{
		...
		// TODO Workaround for #473 and #501 where another mod opens a new gui
		// in response to the MCGuiScreen.init we
		// call from VanillaGuiScreen.register.
		// Ideally, we don't have an hidden inner MCGuiScreen and instead have a
		// common parent class for
		// AbstractGuiScreen, AbstractGuiOverlay and VanillaGuiScreen which
		// deals with the common things. That's
		// quite a bit of changes though, so I'll keep that for 2.7 and have
	...
	private static class Element extends AbstractGuiContainer<Element>
	{
		...
		public ReadableDimension getMinSize()
		{
			...
			return new Dimension(minSize.getWidth() + 20,
				minSize.getHeight() + 20);
		}
