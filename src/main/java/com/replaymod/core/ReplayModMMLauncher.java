...
// We need to wait for MM to call us, otherwise we might initialize our mixins
// before it calls optifabric which would
...
public class ReplayModMMLauncher implements Runnable
{
	...
	public void run()
	{
		// If this is MM2, then we're currently getting called because of our
		// entrypoint declaration.
		// For backwards compatibility with MM1, we also declare our early_riser
		// via custom metadata and MM2 supports
